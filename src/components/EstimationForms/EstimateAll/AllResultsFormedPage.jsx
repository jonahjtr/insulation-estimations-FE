...
const AllResultsFormedPage = ({ data }) => {
  ...
  return (
    <div className="w-full h-full bg-blue">
      ...
      <div className="w-[90%] flex flex-col justify-center items-center text-lg mx-auto text-white">
        ...
        <h2 className="text-2xl font-bold mt-6 text-center md:text-4xl">
          Insulation (not including nineties)
        </h2>
        <div className="w-fit">
          <p>Number of sticks: {Math.ceil(insulation.numberOfSticks)}</p>
        </div>
        <h2 className="text-2xl font-bold mt-6 text-center md:text-4xl">
...
export default AllResultsFormedPage;
